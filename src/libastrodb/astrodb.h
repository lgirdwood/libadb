 ...
 * "ReadMe" file that follows the CDS <A
 * href="http://vizier.u-strasbg.fr/doc/catstd.htx">formatting
 * specifications</A>. Astrodb provides a simple C API for catalog access.
 *
 ...
 * libastrodb is maintained by <A href="mailto:lgirdwood@gmail.com">Liam
 * Girdwood</A>
 *
 */
